...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "scenario", default_value=[default_scenario],
            description="scenario to preprocess",
            ),
        DeclareLaunchArgument(
            "simulation", default_value=[default_simulation],
            description="wind vector-field to load",
            ),
        DeclareLaunchArgument(
            "generateCoppeliaScene", default_value=[str(default_generateCoppeliaScene)],
            description="(bool) wether to generate a coppelia scene from this environment. See the tutorial for requirements",
            ),
        DeclareLaunchArgument(
            "pkg_dir", default_value=[get_package_share_directory("test_env")],
